...
def make_fsl(cfg):
        ...
        # print(support_x.shape) #[1, 10, 3, 84, 84] [1, 50, 3, 84, 84]
            # print(support_y.shape) #[1, 10]            [1, 50]
            # print(query_x.shape) #[1, 150, 3, 84, 84]  [1, 150, 3, 84, 84]
            # pdb.set_trace() 

    # input = torch.randn(1, 50, 3, 84, 84)
    # input1 = torch.randn(1, 50)
    # input2 = torch.randn(1, 150, 3, 84, 84)
    # input3 = torch.randn(1, 150)
    # flops, params = profile(FSLQuery(cfg), inputs=(input,input1,input2,input3, 10, 5))
